znak.innerHTML="-";ravno.innerHTML="=";Fanswer.style.display='table-cell';Sanswer.style.display='table-cell';Tanswer.style.display='table-cell';
//настройки
var MaxSumVal=20;
