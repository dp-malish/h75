...
play_minus.onclick=function(e){
var e=e || window.event;
var target=e.target || e.srcElement;
if(this == target){
	if(fokus.value!=''){if(ansT==1){lowMinus();}else{hiMinus();}}
...
if(fokus.value!=''){if(count_test<20){if(ansT==1){lowMinus();}else{hiMinus();}}}else{alert('Ответ не введён...');fokus.focus();}}};
...
function lowMinus(){
	...
	matMinus();f_float.innerHTML=float1;s_float.innerHTML=float2;fokus.value='';fokus.focus();
}
