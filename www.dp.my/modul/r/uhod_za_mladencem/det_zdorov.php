...
$title='Детское здоровье - Детский портал Малыш';
...
$back_link='детское-здоровье';
$back_link_name='Детское здоровье';

try{if($count_uri_parts>2){throw new Exception();}else{
	if(!isset($uri_parts[1])){
		$page=1;
		include $root.'/modul/r/uhod_za_mladencem/str_navigat.php';
