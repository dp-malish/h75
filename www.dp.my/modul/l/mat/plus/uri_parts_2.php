...
$description='Обучение математике стало интерактивнее. Методики в обучении сложению реализованы для облегчения и завлечения ребёнка к арифметике.';
$keywords='математика, сложение, методики сложения, математика сложение';
$css_down='<link rel="stylesheet" type="text/css" href="/css/mat.css">';


//*************************
if($uri_parts[2]=='с-вариантами-ответа'){
$js_down='<script src="/js/mat/plus_with_hint.js"></script>';
$title='Сложение с вариантами ответа - математика - сайт для детей';
$description.=' При выполнении задания необходимо выбрать ответ...';
$keywords.=', варианты ответа, с вариантами ответа';
$main_content.='<div class="fon_c"><h2>Математика</h2><h3>Сложение с вариантами ответа</h3></div>';
...
//*************************Сложение с указанием ответа
if($uri_parts[2]=='с-указанием-ответа'){

$js_down='<script src="/js/mat/plus.js"></script>';

$title='Сложение с указанием ответа - математика - сайт для детей';
$description.=' При выполнении задания необходимо указывать ответ...';
$keywords.=', с указанием ответа';

$main_content.='<div class="fon_c"><h2>Математика</h2><h3>Сложение с указанием ответа</h3></div>';
$main_content.='<div class="fon_c"><h3>Настройки обучения</h3></div>';
$main_content.='<div class="fon rel">
<div class="tb2_l_col"><span class="ac"><h4>Максимальное значение суммы</h4></span>
<span><input id="level_val" type="range" min="10" max="100" value="20" step="10" id="fader" list="volsettings" oninput="level_val_vol(value);"><datalist id="volsettings"><option>10</option><option>20</option><option>30</option><option>40</option><option>50</option><option>60</option><option>70</option><option>80</option><option>90</option><option>100</option></datalist></span><span id="level_val_result">20</span></div>
<div class="tb2_r_col"><span class="ac"><h4>Параметры обучения</h4></span>
<div class="ff fl ac">
<input type="radio" checked="checked" name="s_test" id="s_test_f" onClick="checkTest();"><label for="s_test_f"> Занятия</label></div>
<div class="ff fl ac"><input type="radio" name="s_test" id="s_test_s" title="Тестирование" onClick="checkTest();"><label for="s_test_s" title="Тестирование"> Тест</label>
...
<img src="/img/mat/jpg.php?img=board">
<div class="cl"></div>
</div>'.$caption1.$caption2.'<div class="cl"></div>';$bad_link=1;}
//*************************
