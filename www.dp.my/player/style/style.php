...
ob_start();include('video225-773.txt');
...
if($l_str>50){header('Content-Encoding: '.$encoding);echo("\x1f\x8b\x08\x00\x00\x00\x00\x00");$main_content=gzcompress($main_content,3);
}}echo $main_content;
?>