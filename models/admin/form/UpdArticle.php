<div class="fon_c"><h4>Статьи</h4><form name="form" class="form" method="post"><input type="hidden" name="id" value="#?">
        ...
        <p>caption | заголовок *</p><input type="text" name="caption" id="caption" required placeholder="Заголовок" maxlength="255" value="#?"><br><br><br>
            ...
            <p>img_i | рисунок</p><input type="number" name="img_i" id="img_i" min="1" placeholder="Номер рисунка (индекс)" value="#?" onchange="img_index()"><div id="img_index_view" class="ac"></div><script type="application/javascript">
            function img_index(){
        ...
        <p>img_s | рисунок</p><input type="number" name="img_s" id="img_s" min="1" placeholder="Номер рисунка (маленький)" value="#?" onchange="img_small()"><div id="img_s_view" class="ac"></div>
        ...
        <p>img | рисунок</p><input type="number" name="img" id="img" min="1" placeholder="Номер рисунка" value="#?" onchange="img_big()"><div id="img_big_view" class="ac"></div><script type="application/javascript">
            function img_big(){
